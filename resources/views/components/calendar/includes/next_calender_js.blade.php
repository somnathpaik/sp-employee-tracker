<script>
    $('.cld_right_arrow').on('click', function() {
        ...
        $('#first_panel_month').text($('#second_panel_month').text())
        $('#second_panel_month').text(monthName[first_month][0] + ' ' + first_month_year)        
        $('#current_month_text').text(monthName[first_month][0])
        var first_panel_trs = ''
        var count = 0
        var date_date = 1
        $('.first_panel').html($('.second_panel').html())
        ...
        $('.second_panel').html(first_panel_trs)

        $('.custom_calendar_td').removeClass('bg_td')
        $('.custom_calendar_td').removeClass('bg_td_style')
        $('.custom_calendar_td').removeClass('bg_td_style1')
        $('.custom_calendar').removeClass('btn-highlighted')
        $('.custom_calendar').removeClass('check_in_date')
        $('.custom_calendar').removeClass('check_out_date')
