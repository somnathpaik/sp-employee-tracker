...
<div id="page-wrapper" style="min-height: 183px;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Client Type</h1>
            </div>
        ...
        <div class="row">
        <div class="col-lg-3">
                <a class="btn btn-info mb-20" href="{{ url('add-client-type') }}" class="active"><i class="fa fa-plus fa-fw"></i>
                        ...
                        <tbody>
                            ...
                            <tr style="background-color:{{$value['background_color']}};  color:{{$value['font_color']}};">
                                ...
                                <td class="text-center">
                                    <a  class="btn btn-warning" href="{{url('/client-type/edit')}}/{{$value->id}}"><i class="fa fa-edit"></i> Edit</button>
